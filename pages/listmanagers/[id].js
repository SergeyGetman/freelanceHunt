    ...
    return (
        <MainContainer>
            <div className={styles.general__block}>
                ...
                <div className={styles.general__block__firstBlock}>
                ...
                <div className={styles.general__block__titleGetRequest}>
                    Working with GET request
                </div>

                <div className={styles.general__block__secondBlock}>
                    <div className={styles.general__block__users}>
                        {usersForCircle?.map((el, idx) => {
                            return (
                                <div className={styles.general__block__users__user} key={idx}>
                                    <UserCircle
                                        image={el.photo}
                                        name={el.name}
                    ...
                    <div className={styles.general__block__users__btn}>
